...
function passwordStrengthCheck(password1, password2, passwordsInfo)
{
	...
	$(password1).on('keyup', function(e) {
    	...
    	{
			passwordsInfo.removeClass().addClass('stillweakpass').html("Weak! (Enter digits to make good password)");
    	}
		else
		{
			passwordsInfo.removeClass().addClass('weakpass').html("Must be 8 or more chars");
		}
	});
